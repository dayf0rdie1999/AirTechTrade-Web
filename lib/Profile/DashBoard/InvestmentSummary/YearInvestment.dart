...
class YearInvestmentSummaryWidget extends StatelessWidget {
  const YearInvestmentSummaryWidget({super.key});
        ...
        child: Padding(
          ...
          child: LineChart(
            LineChartData(
                      ...
                      getTooltipItems: (List<LineBarSpot> touchedBarSpots) {
                        return touchedBarSpots.map((barSpot) {
                          return LineTooltipItem(
                              threeMonthlyInvestSummary[barSpot.spotIndex]
                                  ["Date"],
                              const TextStyle(),
              ...
              maxX: threeMonthlyInvestSummary[
                      threeMonthlyInvestSummary.length - 1]["Index"] +
                  0.50,
              minY: threeMonthlyInvestSummary[0]["Money"] - 100,
              maxY: threeMonthlyInvestSummary[
                      threeMonthlyInvestSummary.length - 1]["Money"] +
                  100,
              lineBarsData: [
                LineChartBarData(
